  ...
  <div class="bx--grid bx--grid--full-width landing-page">
    <div class="bx--row landing-page__banner">
      <div class="bx--col-lg-16">
        ...
        <h1 class="landing-page__heading">Vivian Goldmann</h1>
        <a href="https://www.instagram.com/vigoldmann" target="_blank">
          <img
            class="landing-page__illo"
            src="../../assets/logo--instagram.svg"
            alt="logo Instagram"
        /></a>
        <a href="https://www.linkedin.com/in/vivian-goldmann/" target="_blank">
          <img
            class="landing-page__illo"
            ...
            <div class="bx--grid bx--grid--no-gutter bx--grid--full-width">
              <div class="bx--row landing-page__tab-content">
                <div class="bx--col-md-4 bx--col-lg-7">
                  <h2 class="landing-page__subheading">Sobre mim.</h2>
                  <p class="landing-page__p">
                    Nasci comunicadora, sempre gostei de indagar e investigar.
                    Trabalhei por anos na mídia impressa como repórter de campo,
                    sempre gostei de fazer matérias sobre pessoas
                    (perfil/biografia) e de me aproximar do ser humano. Durante
                    as entrevistas sempre tive a habilidade de fazer com que as
                    pessoas se abrissem. Em 2012 alguns conhecidos me
                    apresentaram uma nova profissão: Coaching. Como boa repórter
                    fui buscar e descobrir mais, e me deparei com o coaching
                    ontológico, e esse seguimento fez muito sentido para mim.
                    ...
                    minha vida, em 2018 tive mais um sinal e uma amiga
                    recomendou o curso de comunicação não violenta, achei muito
              ...
              <div class="bx--row landing-page__tab-content">
                <div class="bx--col-md-4 bx--col-lg-7">
                  <h2 class="landing-page__subheading">
                    Coach Tradicional X Coach Ontológico.
                  </h2>
                  <p class="landing-page__p">
                    É interessante pensar que a base da escola do Coaching
                    Ontológico nasceu na América Latina, enquanto as outras
                    vieram do Canadá e EUA, o que por si só já diferencia na
                    concepção do calor humano e da aproximação na forma de lidar
                    com o ser humano. O Coaching tradicional trabalha com
                    ferramentas para pessoa atingir um objetivo, a meta
                    estabelecida no início do processo de coaching, já o
                    coaching ontológico se preocupa com as necessidades do ser,
                    a sua percepção de si próprio e a própria ampliação de
                    consciência, inclusive para checar se realmente a meta que
                    estabeleceu ainda faz sentido para ele. É uma jornada de
                    ...
                    que o cliente perceba seus diálogos internos e os analise
                    com mais propriedade. Essa formação é apoiada no tripé
                    consciência, responsabilidade e aprendizagem, portanto é
            ...
            <div class="bx--grid bx--grid--no-gutter bx--grid--full-width">
              <div class="bx--row landing-page__tab-content">
                <div class="bx--col-md-4 bx--col-lg-7">
                  ...
                  <p class="landing-page__p">
                    É uma ferramenta que ajuda a expandir a consciência e a
          ...
          <cv-tab label="CNV">
            <div class="bx--grid bx--grid--no-gutter bx--grid--full-width">
              <div class="bx--row landing-page__tab-content">
                <div class="bx--col-md-4 bx--col-lg-7">
                  <h2 class="landing-page__subheading">
                    CNV e Coaching de mãos dadas.
                  </h2>
                  <p class="landing-page__p">
                    Quando comecei a trabalhar com Coaching Ontológico fui
                    percebendo a importância de me aproximar ainda mais do ser
                    humano e, principalmente, dar vazão para ele se compreender
                    mais através de ferramentas que o auxiliavam a se enxergar
                    sob uma nova perspectiva. É preciso lembrar que esse tipo de
                    Coaching se ancora na ideia de que o Coachee (cliente ) é o
                    ...
                    CNV nos convida a olhar para nossos diálogos com os outros,
                    conosco, buscando compreender quais são as necessidades que
                    estão por trás dos sentimentos que surgem durante um
          ...
          <cv-tab label="Luto">
            <div class="bx--grid bx--grid--no-gutter bx--grid--full-width">
              <div class="bx--row landing-page__tab-content">
                <div class="bx--col-md-4 bx--col-lg-7">
                  <h2 class="landing-page__subheading">
                    Luto vai além da morte.
                  </h2>
                  <p class="landing-page__p">
                    Falar sobre esse tema é algo muito complexo, porque muitas
